...
$(function () {
    ...
    // Progressgar1 start
    if ($('#progressbar1')) {
        progress_bar = new ProgressBar.Circle(progressbar1, {
            ...
            step: function (state, circle) {
                ...
                if (value > 1) {
                    ...
                    circle.setText((circle.value() * 100).toFixed(3) + '%');
                }
            }
        });
        progress_bar.text.style.fontFamily = "'Overpass', sans-serif;";
        progress_bar.text.style.fontSize = '32px';
    }
    // Progressgar1 start
